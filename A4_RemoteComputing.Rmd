...
First, a RStudio Server is set up on my virtual machine in the bwCloud and the user **XXX** with the corresponding password **XXX** and restricted permissions is created. The server can be accessed via XXX.
